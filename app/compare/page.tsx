  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background to-card">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Document Comparison</h2>
          <p className="text-muted-foreground">
            Compare multiple documents side-by-side to detect differences,
            changes, and potential data manipulation patterns.
          </p>
        </div>
        ...
        {workflow.documents.length === 0 ? (
          ...
          <>
            <DocumentComparison onComplete={() => {}} />
            <div className="mt-8 flex gap-3">
              <Link href="/compliance">
                <Button>Next: Compliance Check</Button>
              </Link>
              <Link href="/extract">
