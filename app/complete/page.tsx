  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background to-card">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Audit & Export</p>
              </div>
            </Link>
            <Link href="/">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Audit Trail & Export</h2>
          <p className="text-muted-foreground">
            View complete verification history and export comprehensive reports
            in multiple formats.
          </p>
        </div>
