      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">
            Document Insights & Intelligence
          </h2>
          <p className="text-muted-foreground">
            Analyze documents to identify key patterns, anomalies, and insights
        ...
        {workflow.documents.length === 0 ? (
          ...
          <>
            <DocumentInsights onComplete={() => {}} />
            <div className="mt-8 flex gap-3">
              <Link href="/review">
                <Button>Next: Review & Decision</Button>
              </Link>
